...
function render(variables = {}) {
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1> ${variables.name == null ? "Elon" : variables.name} ${
    variables.lastName == null ? "Musk" : variables.lastName
  }</h1>
    ...
    variables.country == null ? "USA" : variables.country
          ...
          <ul class="${variables.socialMediaPosition}">
            ...
            <li><a href="https://github.com/${
              variables.github == null ? "JessCP07" : variables.github
            }"><i class="fab fa-github"></i></a></li>
            <li><a href="https://linkedin.com/${
              variables.linkedin == null
                ? "company/dablim-soluções-gráficas"
                : variables.linkedin
            }"><i class="fab fa-linkedin"></i></a></li>
            <li><a href="https://instagram.com/${
              variables.instagram == null
                ? "elonmusk__official__/"
                : variables.instagram
